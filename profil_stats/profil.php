...
// pour modification de photo de profil
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($donnees['photo'])) {
        $fichier = $donnees['photo'];
          // validation du nouveau nom avec preg_match
          if (preg_match("~modifier_photo~$~", $_SERVER['REQUEST_URI'], $matches)) {
